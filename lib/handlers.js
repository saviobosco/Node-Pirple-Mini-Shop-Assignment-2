...
var htmlHandler = require("./handlers/html/index");
...
/**
 * Adding Html handlers
 * 
 */
handlers.index = htmlHandler.index;
handlers.public = htmlHandler.public;
handlers.accountCreate = htmlHandler.accountCreate;
handlers.accountEdit = htmlHandler.accountEdit;
handlers.sessionCreate = htmlHandler.sessionCreate;
handlers.menusList = htmlHandler.menusList;
handlers.menusView = htmlHandler.menusView;
handlers.cartsList = htmlHandler.cartsList;
handlers.sessionDeleted = htmlHandler.sessionDeleted;
handlers.checkoutCreate = htmlHandler.checkoutCreate;
handlers.checkoutSuccess = htmlHandler.checkoutSuccess;
handlers.purchasesList = htmlHandler.purchasesList;
